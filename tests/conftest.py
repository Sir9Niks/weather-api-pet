...
#     """
#     Хук, который срабатывает после выполнения теста.
#     Если тест провалился — сохраняем подробный лог в файл.
#     """
#     outcome = yield
#     rep = outcome.get_result()
#
#     # Логируем только call (основной этап выполнения теста)
...
#             f.write("-" * 80 + "\n\n")
#
#             # Параметры теста (если есть параметризация)
...
#             else:
#                 f.write("Нет детального traceback (возможно, AssertionError без деталей)\n")
#
#             f.write("\n" + "=" * 80 + "\n")
#             f.write("Конец лога\n")
#
#         logger.info(f"Провал теста '{test_name}' — лог сохранён: {log_filename}")
